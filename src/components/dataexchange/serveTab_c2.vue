<template>
  <div class="colum">
      ...
      <div class="row">
            <DataFrame :width='624' :height='346' frameTitle="接口服务被调用次数排名" :rightFunc="frameSet">
                <ul class="color_list">
            ...
            <DataFrame :width='620' :height='346' frameTitle="接口服务被调用频次趋势分析" :rightFunc="frameSet2">
                <v-chart :options="line" :autoresize='true'/>
            </DataFrame>
            <DataFrame :width='620' :height='346' frameTitle="接口服务被调用成功率分析" :rightFunc="frameSet2">
                <v-chart :options="line" :autoresize='true'/>
            </DataFrame>
      </div>
      <div class="row">
